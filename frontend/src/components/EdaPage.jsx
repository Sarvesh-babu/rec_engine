...
export default function EdaPage({ runId, onBack }) {
  ...
  return (
    <div className="min-h-screen text-slate-900">
      <header className="border-b border-sky-100/80 bg-white/70 backdrop-blur px-6 py-4 flex items-center justify-between shadow-sm">
        <div>
          <h1 className="text-lg font-semibold">Exploratory Data Analysis</h1>
          <p className="text-sm text-slate-500">Distributions and breakdowns from the latest pipeline run.</p>
        </div>
        <button
          onClick={onBack}
      ...
      <main className="max-w-6xl mx-auto px-6 py-8 space-y-8">
        {loading && <p className="text-sm text-slate-500">Loading EDA...</p>}
